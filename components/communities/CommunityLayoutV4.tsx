...
export function CommunityLayoutV4({ community }: CommunityLayoutProps) {
        ...
        <main className="min-h-screen flex flex-col font-[family-name:var(--font-inter)] bg-background">
            ...
            <article className="max-w-3xl mx-auto w-full px-5 py-24 md:py-32">
                ...
                <header className="mb-12 text-center">
                    ...
                    {heroImage && (
                        <div className="relative w-full aspect-video md:aspect-[2/1] rounded-3xl overflow-hidden shadow-xl mb-12 my-8">
                            <Image 
                                src={heroImage} 
                                alt={community.name} 
                                fill 
                ...
                {community.description && (
                    <div className="prose prose-lg dark:prose-invert max-w-none leading-loose mb-8 rich-text">
